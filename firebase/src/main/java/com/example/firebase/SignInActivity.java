...
//    String client_id = "855639177861-mhp002vilemcp0t7di164e5fbkakocvq.apps.googleusercontent.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirebaseAuth = FirebaseAuth.getInstance(FirebaseApp.initializeApp(this));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            if (result.isSuccess()) {
                ...
                Log.i(TAG, "Google Sign In Succesful ");
...
//        Log.e("myLog", "Google Sign In Code." + credential);
        Log.d(TAG, "firebaseAuthWithGooogle:" + acct.getIdToken());
